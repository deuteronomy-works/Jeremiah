...
base_types = ['True', 'False', 'None', 'if', 'elif', 'else', 'for', 'while',
              'class', 'def', 'with', 'as', 'in', 'import', 'from']

base_functions = ['print(', 'list(', 'str(', 'bytes(', 'dict(', 'set(', 'tuple(',
                  'len(', 'format(', 'open(']

base_types_dict = {'True': "<span>True</span>", 'False': "<span>False</span>",
                   'None': "<span>None</span>",'if': "<span>if</span>",
